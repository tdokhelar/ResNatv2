...
class ConfigurationDuplicates
{
    ...
    private $duplicatesByAggregation = false;
    ...
    /**
     * Get the value of duplicatesByAggregation
     */
    public function getDuplicatesByAggregation()
    {
        return $this->duplicatesByAggregation;
    }

    /**
     * Set the value of duplicatesByAggregation
     *
     * @return  self
     */
    public function setDuplicatesByAggregation($duplicatesByAggregation)
    {
        $this->duplicatesByAggregation = $duplicatesByAggregation;
